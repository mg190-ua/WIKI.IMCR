...
![image](Images/CNN/perceptron.png {width=250px})

## Capas  Neuronales

![image](Images/CNN/nonlinearboundary.png {width=250px})

![image](Images/CNN/layer.png {width=250px})

## Redes Neuronales Profundas (DNN)

![image](Images/CNN/dnn.png {width=250px})

## Convolución

![image](Images/CNN/discreteconvolution.png {width=250px})

## Capas Convolucionales

![image](Images/CNN/convolutionallayer.png {width=250px})